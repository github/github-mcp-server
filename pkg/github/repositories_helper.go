...
func isGitRefUpdateConflict(err error, _ *github.Response) bool {
...
func ensurePushFilesBranchRef(ctx context.Context, client *github.Client, owner, repo, branch string) (string, error) {
	...
	_, resp, err := client.Git.GetRef(ctx, owner, repo, refName)
	if err == nil {
...
func commitEntriesToRef(
	...
	for attempt := range maxGitRefUpdateRetries {
