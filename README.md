...
- **get_code_scanning_alert** - Get code scanning alert
  - **OAuth Scope Policy**: (`repo` OR `security_events`)
  - **Preferred OAuth Challenge**: `security_events`
...
- **get_team_members** - Get team members
  - **OAuth Scope Policy**: (`admin:org` OR `read:org` OR `write:org`)
  - **Preferred OAuth Challenge**: `read:org`
...
- **list_issue_fields** - List issue fields
  - **OAuth Scope Policy**: `repo` OR (`admin:org` OR `read:org` OR `write:org`)
  - **Preferred OAuth Challenge**: `repo`
...
- **dismiss_notification** - Dismiss notification
  - **OAuth Scope Policy**: `notifications`
...
- **projects_get** - Get details of GitHub Projects resources
  - **OAuth Scope Policy**: (`project` OR `read:project`)
  - **Preferred OAuth Challenge**: `read:project`
...
- **delete_repository** - Delete repository
  - **OAuth Scope Policy**: `delete_repo` AND `repo`
  - `owner`: Repository owner (username or organization) (string, required)
  - `repo`: Repository name (string, required)
